...
import {
  getChangeIntensityColor,
  getStockIcon,
  formatStockSubtitle,
  getMarketColor,
} from "../utils/stock-helpers";
...
export function useStockListItem({
  stock,
  t,
  watchlistId,
  onRemoveFromWatchlist,
}: UseStockListItemProps) {
  ...
  const title =
    "exchange" in stock
      ? formatStockSubtitle(
          stock as StockItem,
          t.common.defaultExchange,
          DISPLAY_CONSTANTS.MAX_TITLE_LENGTH
        )
