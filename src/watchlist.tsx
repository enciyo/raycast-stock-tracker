...
export default function WatchlistCommand() {
  ...
  const filteredStocks = selectedWatchlist
    ? filterStocksByQuery(selectedWatchlist.stocks, searchQuery)
    : [];
  ...
  return (
    <List
      ...
      searchBarPlaceholder={
        selectedWatchlist ? `Search in ${selectedWatchlist.name}...` : "Search stocks..."
      }
      navigationTitle={
        selectedWatchlist
          ? `${selectedWatchlist.pinned ? "📌 " : ""}${selectedWatchlist.name}`
          : "Watchlists"
      }
