...
export function CopyActionsSection({
  stock,
  showWatchlistActions,
  handleCopySymbol,
  t,
}: CopyActionsSectionProps) {
  return (
    <ActionPanel.Section title={t.actions.copySectionTitle}>
      <Action.CopyToClipboard
        ...
        shortcut={
          showWatchlistActions ? { modifiers: ["cmd"], key: "c" } : { modifiers: [], key: "enter" }
        }
      ...
      {stock.price !== undefined && (
        <Action.CopyToClipboard
          content={formatPrice(stock, undefined, t.common.na)}
          title={t.actions.copyPrice}
        />
      )}
    </ActionPanel.Section>
  );
